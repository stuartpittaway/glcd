@echo off
REM # Note/Warning:
REM # This batch file is no longer maintained/supported.
REM # It has been superceded by the new bash script method.
REM # It may continue to work for quite some time as no new
REM # features were added when the bash script was originally created.
REM #
REM ##################################################################
...
REM # and batch file is run from distbuild or one directory lower
REM #

set ARDUINO-0017_UTILDIR=..\..\..\..\tools\avr\utils\bin
set ARDUINO-0017a_UTILDIR=..\..\..\..\..\tools\avr\utils\bin
set ARDUINO-0018_UTILDIR=..\..\..\..\hardware\tools\avr\utils\bin
set ARDUINO-0018a_UTILDIR=..\..\..\..\..\hardware\tools\avr\utils\bin
...
REM # (the "a" directories are for when the batch file is placed on level
REM # lower than the distbuild directory)
REM #

for %%G in (%ARDUINO-0018_UTILDIR% %ARDUINO-0018a_UTILDIR% %ARDUINO-0017_UTILDIR% %ARDUINO-0017_UTILDIR% %WINAVR_UTILDIR%) do (
	if exist %%G (
